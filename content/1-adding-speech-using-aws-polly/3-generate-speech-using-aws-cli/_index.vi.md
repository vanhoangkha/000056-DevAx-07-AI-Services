...
Nếu sử dụng **mpg123**, bạn có thể tải xuống tại [link](https://www.mpg123.de/download/win64/1.26.3/) và giải nén chúng. Hoặc có thể mở **PowerShall** và chạy câu lệnh: `choco install mpg123`.
